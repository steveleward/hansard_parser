...
def random_color_func(word=None, font_size=None, position=None,
                      orientation=None, font_path=None, weight=None, random_state=None, **kwargs):
...
class WordCloud(object):
    ...
    def generate_from_frequencies(self, frequencies, **kwargs):
        """Create a word_cloud from words and frequencies.
        ...
        for word, count in frequencies:
            ...
            colors.append(self.color_func(word, font_size=font_size,
                                          ...
                                          font_path=self.font_path, **kwargs))
    ...
    def recolor(self, random_state=None, color_func=None):
        ...
        self.layout_ = [(word_freq, font_size, position, orientation,
                         color_func(word=word_freq[0], font_size=font_size,
                                    ...
                                    random_state=random_state, font_path=self.font_path, ordinal=i, **kwargs))
                        for i, (word_freq, font_size, position, orientation, _) in enumerate(self.layout_)]
        return self
